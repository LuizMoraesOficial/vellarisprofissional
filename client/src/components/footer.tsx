...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <section className="relative bg-background dark:bg-gray-950 py-24">
      ...
      <div className="relative h-16 bg-background dark:bg-gray-950">
        <svg 
        ...
        >
          <path 
            d="M0 64H1440V32C1440 32 1320 0 720 0C120 0 0 32 0 32V64Z" 
